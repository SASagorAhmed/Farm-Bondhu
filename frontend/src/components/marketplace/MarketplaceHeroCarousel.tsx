...
const DEFAULT_BANNERS: HeroBanner[] = [
  {
    ...
    subtitle: "Feed, seeds, fertilizer & organic products — best prices every day",
    cta: "Shop Farm",
  ...
  },
  {
    ...
    subtitle: "Human medicine, vaccines & health care from verified sellers",
    cta: "Shop MediBondhu",
    href: "/marketplace?lane=medibondhu",
    gradient: "linear-gradient(135deg, #12C2D6 0%, #0891B2 100%)",
  },
  {
    id: "vetbondhu",
    title: "VetBondhu Pharmacy",
    subtitle: "Animal medicine, vaccines & vet equipment for your livestock",
    cta: "Shop VetBondhu",
    href: "/marketplace?lane=vetbondhu",
