  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard title="Avg Rating" value={vets.length ? (vets.reduce((s, v) => s + v.rating, 0) / vets.length).toFixed(1) : "0"} icon={<Star className="h-5 w-5" />} iconColor={VB} index={2} />
        <StatCard title="Specialities" value={SPECIALITIES.length} icon={<Heart className="h-5 w-5" />} iconColor={VB} index={3} />
      </div>
